...
### 🐛 Minor Issues
1. **Дублирование информации в ответах**
   - Иногда AI повторяет информацию о доступности мастера
   - Добавлено правило #13, требует тестирования

2. **Фразы "Проверяю..." в ответах**
   - AI иногда говорит "проверяю расписание" вместо молчаливой проверки
   - Требует дополнительной настройки промптов
