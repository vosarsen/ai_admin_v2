      ...
      for (const client of allClients) {
        try {
          const clientData = {
            ...
            total_spent: client.sold_amount || client.spent || 0,
            ...
            loyalty_level: this._calculateLoyaltyLevel(client.visits_count, client.sold_amount || client.spent || 0),
            client_segment: this._calculateClientSegment(client.visits_count, client.sold_amount || client.spent || 0),
            average_bill: client.visits_count > 0 ? ((client.sold_amount || client.spent || 0) / client.visits_count) : 0,
