...
- [ ] Реализация реальной статистики загруженности салона (businessStats)
  - Вместо захардкоженных 50 слотов считать реальное количество
  - Учитывать рабочие часы и длительность услуг
  - Показывать процент загруженности по мастерам
