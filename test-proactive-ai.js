#!/usr/bin/env node
// test-proactive-ai.js - Тест проактивной AI логики

const proactiveSuggestions = require('./src/services/ai/proactive-suggestions');

async function testProactiveAI() {
  console.log('🤖 Testing Proactive AI Suggestions...\n');
  ...
  try {
    ...
    console.log('💡 Умные предложения: РАБОТАЕТ (разные типы предложений)');
...
module.exports = testProactiveAI;