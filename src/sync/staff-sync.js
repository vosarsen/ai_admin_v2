...
class StaffSync {
  ...
  prepareStaffData(staff) {
    return {
      ...
      position_title: staff.position?.title || null,
      phone: staff.phone || null,
      email: staff.email || null,
      avatar: staff.avatar || staff.avatar_big || null,
      is_active: staff.hidden === 0 || staff.hidden === "0",
      is_master: staff.is_master === 1 || staff.is_master === "1",
      rating: staff.rating || 0,
      weight: staff.weight || 0,
      bookable: staff.bookable !== 0 && staff.bookable !== "0",
      description: staff.information || staff.comment || null,
