...
КРИТИЧЕСКИ ВАЖНО: 
1. НЕ ДОБАВЛЯЙ поле "response" в ответ!
2. НИКОГДА не выбирай мастера сам - staff = null, если клиент НЕ НАЗВАЛ имя явно!`;
...
9. staff = null если не указан явно (КРИТИЧЕСКИ ВАЖНО: НИКОГДА не выбирай мастера сам! Только если клиент явно назвал имя!)
...
1. Если клиент говорит "хочу записаться сегодня вечером":
{
  ...
  "entities": {
    "service": null,
    "staff": null,  // ВСЕГДА null если имя не названо!
    "date": "${currentDate}",
    "time": null,
    "time_preference": "evening"
  },
  "confidence": 0.9,
  "reasoning": "Неопределенное время, мастер не указан - покажем все доступные слоты"
}
