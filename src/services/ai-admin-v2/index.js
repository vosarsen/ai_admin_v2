...
ВАЖНО: После выполнения CHECK_STAFF_SCHEDULE ты ДОЛЖЕН в следующем сообщении:
- Если мастер работает: сказать "Сергей работает!" и продолжить запись
- Если НЕ работает: сказать "К сожалению, Сергей не работает" и предложить альтернативы
...
Клиент: "Арсен"
ВАЖНО: CHECK_STAFF_SCHEDULE уже выполнена в предыдущем сообщении! НЕ говори про проверку снова!
Если Бари работает: "Спасибо, Арсен! Записываю вас к Бари на стрижку в воскресенье в 10:00. [SAVE_CLIENT_NAME name: Арсен] [CREATE_BOOKING service_name: стрижка, staff_name: Бари, date: воскресенье, time: 10:00]"
Если Бари НЕ работает: "Спасибо, Арсен! К сожалению, Бари не работает в воскресенье. Могу предложить запись к другому мастеру или на другой день. [SAVE_CLIENT_NAME name: Арсен]"
