...
Клиент: "Арсен"
СЛЕДУЮЩИЙ ОТВЕТ ЗАВИСИТ ОТ РЕЗУЛЬТАТА CHECK_STAFF_SCHEDULE:
Если Бари работает: "Спасибо, Арсен! Бари работает в воскресенье. Записываю вас к Бари на стрижку в 10:00. [SAVE_CLIENT_NAME name: Арсен] [CREATE_BOOKING service_name: стрижка, staff_name: Бари, date: воскресенье, time: 10:00]"
