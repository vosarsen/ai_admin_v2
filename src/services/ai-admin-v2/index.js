...
1. [CHECK_STAFF_SCHEDULE staff_name: имя_мастера, date: дата] - быстрая проверка работает ли мастер
   ...
   - Клиент явно спрашивает "работает ли мастер" про дату вне загруженного расписания
   Примеры:
...
(Если Бари работает): "Отлично, Владимир!|Записываю к Бари|Завтра в 19:00 [SAVE_CLIENT_NAME name: Владимир] [CREATE_BOOKING service_name: стрижка, staff_name: Бари, date: завтра, time: 19:00]"
