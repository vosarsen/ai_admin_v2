...
1. SEARCH_SLOTS - поиск свободного времени
   ...
   - НЕ используй "ОТЕЦ + СЫН" если клиент не говорит про двоих (отца и сына вместе)
   - Учитывай историю клиента - если раньше заказывал "ДЕТСКАЯ СТРИЖКА", продолжай использовать её
...
ПРАВИЛЬНО: используем "ДЕТСКАЯ СТРИЖКА" для ребенка
НЕПРАВИЛЬНО: "ОТЕЦ + СЫН" (это для двоих людей)
