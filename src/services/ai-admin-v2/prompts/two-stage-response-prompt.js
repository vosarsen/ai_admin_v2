...
- Если клиент спрашивает "что это?" про услугу:
  * Смотри на название услуги из SHOW_PRICES результата
  * Объясняй в контексте ${terminology.businessType}
  * Пример: "экспресс-стрижка" в барбершопе = быстрая стрижка (НЕ маникюр!)
  * Пример: "стрижка + борода" = комплексная услуга (стрижка + уход за бородой)
