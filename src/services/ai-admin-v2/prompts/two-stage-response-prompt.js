...
Вижу, что вы обычно записываетесь на [перечислить услуги в винительном падеже через "или"].

${если нет topServices или пустой}
У нас есть различные услуги - стрижки, укладки, бороды и другие.

Уточните, пожалуйста, что вас интересует?"

📅 НЕТ СЛОТОВ (SEARCH_SLOTS пусто без requiresServiceSelection):
"К сожалению, на [дата] все время занято для [услуга].
