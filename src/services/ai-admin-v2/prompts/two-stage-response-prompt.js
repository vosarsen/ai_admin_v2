...
"[Имя], к сожалению, на [дата] у [имя мастера в родительном падеже] нет достаточно времени для полного выполнения [услуга в родительном падеже] (требуется [requiredMinutes] минут).

Есть окна:
[список окон с указанием доступного времени]

У вас есть несколько вариантов:
1. Выбрать только одну услугу, которая уместится в доступное время
2. Записаться на другой день, когда будет больше времени
3. Выбрать другого мастера
