...
4. response - ответ клиенту. КРИТИЧЕСКИ ВАЖНО:
   - Для action "search_slots" ОБЯЗАТЕЛЬНО возвращай response: null
   - НЕ проси уточнить услугу/мастера - мы используем популярные по умолчанию
   - НЕ генерируй промежуточные сообщения типа "Укажите услугу"
   - Отвечай только когда action="none" или есть конкретный вопрос
